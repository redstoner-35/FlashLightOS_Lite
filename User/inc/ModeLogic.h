...
#define TurboSel_IOB STRCAT2(GPIO_P,TurboSel_IOBank)
#define TurboSel_IOG STRCAT2(HT_GPIO,TurboSel_IOBank)
#define TurboSel_IOP STRCAT2(GPIO_PIN_,TurboSel_IOPinNum)
